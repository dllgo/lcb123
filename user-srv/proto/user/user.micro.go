...
type UserService interface {
	...
	UserDetail(ctx context.Context, in *UserRequest, opts ...client.CallOption) (*UserInfo, error)
}
...
func (c *userService) UserDetail(ctx context.Context, in *UserRequest, opts ...client.CallOption) (*UserInfo, error) {
	req := c.c.NewRequest(c.name, "User.UserDetail", in)
	out := new(UserInfo)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
type UserHandler interface {
	...
	UserDetail(context.Context, *UserRequest, *UserInfo) error
}
...
func RegisterUserHandler(s server.Server, hdlr UserHandler, opts ...server.HandlerOption) error {
	type user interface {
		...
		UserDetail(ctx context.Context, in *UserRequest, out *UserInfo) error
	}
	type User struct {
		user
	}
...
func (h *userHandler) UserDetail(ctx context.Context, in *UserRequest, out *UserInfo) error {
	return h.UserHandler.UserDetail(ctx, in, out)
}
